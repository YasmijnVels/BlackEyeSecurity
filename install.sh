...
if [ -f "/etc/debian_version" ]; then
        ...
        echo "[i] We will now download BlackEyeSecurity..."
        sudo git clone https://github.com/YasmijnVels/BlackEyeSecurity.git > /dev/null 2>&1 || echo "[!] Could not download BlackEyeSecurity."
        cd BlackEyeSecurity > /dev/null 2>&1
        ...
        echo "[i] We will now install BlackEyeSecurity..."
        sudo bash ./install_to_bin.sh || echo "[!] Could not install BlackEyeSecurity."
        ...
        git clone https://github.com/YasmijnVels/BlackEyeSecurity.git > /dev/null 2>&1 || echo "[!] Please install git"
        cd BlackEyeSecurity
