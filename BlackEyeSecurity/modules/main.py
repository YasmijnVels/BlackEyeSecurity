...
C_W
 ...
 _     _   _   _   _   _   _   _   _   _  
 / \ / \ / \ / \ / \ / \ / \   / \ / \   / \ / \ / \   / \ / \ / \ / \ / \ / \ / \ / \ / \ 
( W | e | l | c | o | m | e ) ( T | o ) ( O | u | r ) ( D | a | s | h | b | o | a | r | d )
 \_/ \_/ \_/ \_/ \_/ \_/ \_/   \_/ \_/   \_/ \_/ \_/   \_/ \_/ \_/ \_/ \_/ \_/ \_/ \_/ \_/ 


BY USING THIS SOFTWARE, YOU MUST AGREE TO TAKE FULL RESPONSIBILITY
FOR ANY DAMAGE CAUSED BY BlackEyeSecurity.
BlackEyeSecurity SHOULD NOT SUGGEST PEOPLE TO PERFORM ILLEGAL ACTIVITIES.
C_Bo-----------------------------------------------------------C_W""")
	...
	def _add_commands(self):
		...
		event.help(["exit", "quit", "e", "q"], "Exit BlackEyeSecurity.")
		event.help("help", "View all commands.")
		event.help("upgrade", "Upgrade BlackEyeSecurity.")
		...
		event.help("ddos", "Connect to a BlackEyeSecurity server.")
		event.help_comment("\nModules:")
	...
	def upgrade():
		try:
			chdir("/tmp")
			system("sudo git clone https://github.com/YasmijnVels/BlackEyeSecurity.git")
			chdir("/tmp/BlackEyeSecurity/")
			system("sudo bash ./install_to_bin.sh")
			print("[i] Deleting the temporary stored BlackEyeSecurity...")
			system("sudo rm -rf -i /tmp/BlackEyeSecurity/")
			var.stop()
			quit()
		except Exception:
			print("Cound not upgrade BlackEyeSecurity. (Make sure to use sudo)")
